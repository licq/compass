...
docker run -d -p 80:80 -v /data/logs:/data -v /data/assets:/compass/assets --link mongodb:mongodb --link redis:redis --link elasticsearch:elasticsearch --link parser:parser --name web lingpin/web:1.0.36