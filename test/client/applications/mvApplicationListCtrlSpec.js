  ...
  ['new', 'undertimined', 'pursued'].forEach(function (status) {
    describe('/applications/' + status, function () {
      ...
      describe('pursued', function () {
        ...
        it('should put /api/applicatioins/:id and delete from client and retrive one more', function () {
          $httpBackend.expectGET('/api/applications?page=10&pageSize=1&status=' + status).respond({
            hits: {
              hits: [
                {
      ...
      describe('undetermined', function () {
        ...
        it('should put /api/applications/:id and delete from client and retrive one more', function () {
          $httpBackend.expectGET('/api/applications?page=10&pageSize=1&status=' + status).respond({
            hits: {
              hits: [
                {
